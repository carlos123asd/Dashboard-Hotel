        ...
        return <>
            <ContentPageMain>
                <div className="parent">
                    <Card className="mx-auto w-full flex-1 items-center justify-between px-7 py-7 bg-white border-1 hover:shadow-lg hover:scale-105 rounded-lg transition-all div1">
                        <div className="flex items-center">
                            ...
                            <div className="flex-column items-center space-x-2.5">
                                <p className="font-titDashboard ml-2.5 text-gray-700 dark:text-gray-300">{monthActual}</p>
                                <span className="font-subTitDashboard text-sm text-gray-500 dark:text-gray-500">
                                    New Bookings
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center space-x-2.5 mt-3 place-content-between">
                            ...
                            <span className="rounded bg-green-400 px-2 py-1 text-sm font-medium text-white">
                                +1.72%
                            </span>
                        </div>
                    </Card>
                    <Card className="mx-auto w-full flex-1 items-center justify-between px-7 py-7 bg-white border-1 hover:shadow-lg hover:scale-105 rounded-lg transition-all div2">
                        <div className="flex items-center">
                        ...
                        <div className="flex items-center space-x-2.5 mt-3 place-content-between">
                            ...
                            <span className="rounded bg-yellow-400 px-2 py-1 text-sm font-medium text-white">
                                -1.72%
                            </span>
                        </div>
                    </Card>
                    <Card className="mx-auto w-full flex-1 items-center px-7 py-7 bg-white border-1 hover:shadow-lg hover:scale-105 rounded-lg transition-all mt-5 div3">
                        <div className="flex items-center">
                            ...
                            <div className="flex-column items-center space-x-2.5">
                                <p className="font-titDashboard ml-2.5 text-gray-700 dark:text-gray-300">Today</p>
                                <span className="font-subTitDashboard text-sm text-gray-500 dark:text-gray-500">
                                    Check In
                                </span>
                            </div>
                    ...
                    <Card className="mx-auto w-full flex-1 items-center px-7 py-7 bg-white border-1 hover:shadow-lg hover:scale-105 rounded-lg transition-all mt-5 div4">
                        <div className="flex items-center">
                    ...
                    <Card className="mx-auto h-auto w-full flex flex-col items-center gap-10 bg-gradient-to-br from-teal-400 to-green-500 hover:shadow-lg hover:scale-105 transition-all justify-center div5">
