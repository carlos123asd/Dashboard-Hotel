...
export default function Main(){
    ...
    if(loading === true){
        ...
        return <>
            <ContentPageMain>
            <KpiDashboard>
                    <Card className="mx-auto w-80 flex-column max-w-lg items-center justify-between px-7 py-7 bg-white border-1 hover:shadow-lg hover:scale-105 rounded-lg transition-all">
                    ...
                    <Card className="mx-auto w-80 flex-column max-w-lg items-center justify-between px-7 py-7 bg-white border-1 hover:shadow-lg hover:scale-105 rounded-lg transition-all">
                        <div className="flex items-center">
                            ...
                            <div className="flex-column items-center space-x-2.5">
                                <p className="font-titDashboard ml-2.5 text-gray-700 dark:text-gray-300">Booking</p>
                                <span className="font-subTitDashboard text-sm text-gray-500 dark:text-gray-500">
                                    Bookeds Rooms
                                </span>
                            </div>
